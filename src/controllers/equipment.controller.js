...
export class EquipmentController {
    ...
    async create(req, res) {
        try {
            const { code, name, category, brand, serialNumber, purchaseDate, warrantyEndDate, status, condition, description, labId, } = req.body;
    ...
    async update(req, res) {
        try {
            ...
            if (code && code !== existingEquipment.code) {
                const equipmentWithCode = await equipmentService.findByCodeAndCampus(code, newCampusId);
