...
export class InventoryController {
  // Equipment endpoints
  async findAllEquipment(req: AuthRequest, res: Response): Promise<void> {
    try {
  ...
  async findEquipmentById(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      const access = checkResourceAccess(
        req.user!,
        equipment.lab?.campusId || undefined
      );
  ...
  async updateEquipment(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      const access = checkResourceAccess(
        req.user!,
        existingEquipment.lab?.campusId || undefined
      );
      ...
      const equipment = await inventoryService.update(
        id,
        {
          name,
          category,
  ...
  // Lab endpoints
  async findAllLabs(req: AuthRequest, res: Response): Promise<void> {
    try {
      const user = req.user!;
      const role = user.role as ExtendedRole;
  ...
  async findLabById(req: AuthRequest, res: Response): Promise<void> {
    try {
      const id = req.params.id as string;
