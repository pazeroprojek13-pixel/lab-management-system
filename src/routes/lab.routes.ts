...
router.post(
  '/',
  requireRole(Role.SUPER_ADMIN, Role.DEVELOPER, Role.ADMIN),
  (req, res) => labController.create(req, res)
);
...
router.put(
  '/:id',
  requireRole(Role.SUPER_ADMIN, Role.DEVELOPER, Role.ADMIN),
  (req, res) => labController.update(req, res)
);
...
router.delete(
  '/:id',
  requireRole(Role.SUPER_ADMIN, Role.DEVELOPER, Role.ADMIN),
  (req, res) => labController.delete(req, res)
);
...
router.patch(
  ...
  (req, res) => labController.restore(req, res)
);
