...
router.post(
  ...
  (req, res) => campusController.create(req, res)
);
...
router.put(
  '/:id',
  requireRole(Role.SUPER_ADMIN, Role.DEVELOPER),
  (req, res) => campusController.update(req, res)
);
...
router.delete(
  '/:id',
  requireRole(Role.SUPER_ADMIN, Role.DEVELOPER),
  (req, res) => campusController.delete(req, res)
);
...
router.patch(
  '/:id/restore',
  requireRole(Role.SUPER_ADMIN, Role.DEVELOPER),
  (req, res) => campusController.restore(req, res)
);
