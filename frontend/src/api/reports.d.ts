export interface IncidentSummaryData {
    ...
    aging: {
        byCategory: Array<{
            agingCategory: '0-24h' | '24-72h' | '3-7d' | '>7d';
            count: number;
        }>;
        details: Array<{
            incidentId: string;
...
export declare const reportsApi: {
    getIncidentsSummary(): Promise<IncidentSummaryData>;
    getEquipmentHealth(): Promise<EquipmentHealthData>;
    getMaintenanceCost(): Promise<MaintenanceCostData>;
};
